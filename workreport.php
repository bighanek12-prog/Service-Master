...
<div class="col-sm-9 col-md-10 mt-5 text-center">
  <form action="" method="POST" class="d-print-none">
    <div class="form-row">
      ...
      <div class="form-group">
        <input type="submit" class="btn btn-inverse-primary" name="searchsubmit" value="Search">
      </div>
    </div>
  </form>
  <?php
 if(isset($_REQUEST['searchsubmit'])){
  ...
  while($row = $result->fetch_assoc()){
    ...
    echo '<tr>
    <td><form class="d-print-none"><input class="btn btn-inverse-danger" type="submit" value="Print" onClick="window.print()"></form></td>
  </tr></tbody>
  </table>';
  } else {
