...
<div class="col-sm-6 mt-5  mx-3">
 ...
 <div class="text-center">
  <form class='d-print-none d-inline mr-3'><input class='btn btn-inverse-danger' type='submit' value='Print' onClick='window.print()'></form>
  <form class='d-print-none d-inline' action="Workorder.php"><input class='btn btn-inverse-secondary' type='submit' value='Close'></form>
 </div>
</div>
