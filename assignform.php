...
<div class="col-sm-5 mt-5 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="form-row">
      <div class="form-group ">
        <label for="assigntech"><b>Assign to Technician *</b></label>
        <select class="form-select" id="assigntech" name="assigntech">
                          <option>Technician1</option>
                          <option>Technician2</option>
                          <option>Technician3</option>
                          <option>Technician4</option>
                          <option>Technician5</option>
                         </select> 
      </div>
    ...
    <div class="float-right">
      <button type="submit" class="btn btn-inverse-success" name="assign">Assign</button>
      <button type="reset" class="btn btn-inverse-secondary">Reset</button>
    </div>
  </form>
